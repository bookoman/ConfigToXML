	...
	public class ExchangeViewUI extends View {
		...
		protected var uiXML:XML =
			<View>
			  ...
			  <Button label="转换" skin="png.comp.button" x="317" y="308" width="138" height="41" var="btnExchange" labelSize="24"/>
			  <Button label="浏览" skin="png.comp.button" x="149" y="308" width="138" height="41" var="btnBrowse" labelSize="24"/>
			  <Label x="57" y="20" width="494" height="141" size="20" text="将要转换得CSV，EXCEL(只支持.xls，其他请转到此版本)配置放到一个文件夹下，然后点击浏览按钮选择该文件夹，最后点击转换，稍等片刻，会在同目录下生成对应名字得XML配置。" multiline="true" wordWrap="true" color="0xff0000" indent="30" leading="5" font="Microsoft YaHei"/>
